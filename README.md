...
```
As you can see this class will help you transfer data to Innet or Bundle and back which is convinient way for transfer arguments to fragments, activities and etc.
